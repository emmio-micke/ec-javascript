...
x Klassen behöver ha egenskaper för kontoägare och saldo. Det räcker med en sträng och ett tal.
x Skriv metoder som låter användaren sätta in och ta ut pengar.
x Lägg in lämpliga felkontroller.
x Gör en metod som skriver ut kontots ägare och saldo.

Del 2

x Skapa en Person-klass med lämpliga egenskaper.
x Byt ut kontoägaren mot ett objekt av klassen Person.

Del 3

x Skapa en metod för att föra över pengar mellan två konton.
x Skapa en egenskap hos kontot där man kan lagra transaktioner som en sträng, typ "100 kr från Mickes konto till Jessicas konto". Se till att man kan lägga till flera transaktioner.
x Skapa en metod för kontoutdrag, dvs att skriva ut alla transaktioner.

Del 4

x Skapa en klass som hanterar transaktioner. Den ska ha egenskaper för klockslag, från-konto, till-konto och summa.
x Byt ut transaktionerna i del 3 till objekt av transaktionsklassen.
x Anpassa metoden för kontoutdrag.
